 ...
 * Sun Sep 12 2021 21:15:57 GMT-0400 (Eastern Daylight Time)
...
var questionCount, ans1, questionState, questionNumber, questionText, quizData, lastClick, ans2, buttonName, ans3, ans4, correctCount, ans5, currentlySelected;
...
// Describe this function...
function textChange() {
  setHTMLElemAttribute('innerHTML', questionText, ['QUERYSELECTOR', '#question'], true);
  setHTMLElemAttribute('innerHTML', buttonName, ['QUERYSELECTOR', '#submit'], true);
}
...
// Describe this function...
function storeData() {
  quizData[questionNumber] = lastClick;
}
...
registerOnClick(['ALL_OBJECTS'], false, false, [0,1,2], function() {
  if (questionState) {
    if (questionNumber == 0) {
      storeData();
      questionText = 'Select the Inner Core';
      setHTMLElemAttribute('innerHTML', 'Select the Inner Core', ['QUERYSELECTOR', '#question'], true);
      questionNumber = 1;
      questionState = false;
    } else if (questionNumber == 1) {
      storeData();
      questionText = 'Select the Outer Core';
      setHTMLElemAttribute('innerHTML', 'Select the Outer Core', ['QUERYSELECTOR', '#question'], true);
      questionNumber = 1;
      questionState = false;
    } else if (questionNumber == 2) {
      storeData();
      questionText = 'Select the Lower Mantle';
      setHTMLElemAttribute('innerHTML', 'Select the Lower Mantle', ['QUERYSELECTOR', '#question'], true);
      questionNumber = 1;
      questionState = false;
    } else if (questionNumber == 3) {
      storeData();
      questionText = 'Select the Upper Mantle';
      setHTMLElemAttribute('innerHTML', 'Select the Upper Mantle', ['QUERYSELECTOR', '#question'], true);
      questionNumber = 1;
      questionState = false;
    } else if (questionNumber == 4) {
      storeData();
      questionText = 'Select the Crust';
      setHTMLElemAttribute('innerHTML', 'Select the Crust', ['QUERYSELECTOR', '#question'], true);
      setHTMLElemAttribute('innerHTML', 'Results', ['QUERYSELECTOR', '#submit'], true);
      registerOnClick(['QUERYSELECTOR', '#submit'], false, false, [0,1,2], function() {
        setHTMLElemAttribute('href', 'quiz-score.html', ['QUERYSELECTOR', '#submit'], true);
      }, function() {});
      questionNumber = 1;
      questionState = false;
      ...
      storeData();
      getScore();
      setHTMLElemAttribute('innerHTML', ['You got ',correctCount,' out of 5 questions correct.'].join(''), ['QUERYSELECTOR', '#submit'], true);
    }
  }
}, function() {});
